...
GO
PRINT N'Creating Procedure [dbo].[usp_GetConnectorsByStationId]...';
...
AS
	...
	WHERE 
		[Id] = @id
GO
PRINT N'Creating Procedure [dbo].[usp_GetStationsByGroupId]...';
...
AS
	...
	WHERE 
		[GroupId] = @groupId
GO
PRINT N'Creating Procedure [dbo].[usp_RemoveConnector]...';
...
AS
    ...
    WHERE
        [Id] = @id
GO
PRINT N'Creating Procedure [dbo].[usp_UpdateGroupCurrent]...';
...
AS
    ...
    WHERE
        [Id] = @id
GO
PRINT N'Creating Procedure [dbo].[usp_UpdateStationCurrent]...';
